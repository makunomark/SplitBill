                                                        ...
                                                        for (int m = 0; m < contact_list.size(); m++) {
                                                            if (contact_list.get(m).getF_name().equals(arrayAdapter.getItem(which))) {
                                                                ...
                                                                if (new_amount < 0) {
                                                                    ...
                                                                    debt.setDebtor_no(contact_list.get(m).getF_name() + contact_list.get(m).getL_name());
                                                                }
                                                            }
                                                        }
                                                        debt.setAmount(String.valueOf(amount));
                                                        debt.setLender_no(contact_list.get(item_id).getF_name() + contact_list.get(item_id).getL_name());
                                                        debtors.add(debt);
