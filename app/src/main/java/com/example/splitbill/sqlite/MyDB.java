...
public class MyDB {
    ...
    public long deleteDebtRecord(int id){
        Log.i("value of _id", id+"");
        try{
            return db.delete(Constants.TABLE_NAME_DEBTS, Constants.KEY_ID + " = " + id, null);
    ...
    public Cursor getRecords() {
        String orderBy = Constants.DATE+" DESC";
        return db.query(Constants.TABLE_NAME, null, null, null, null, null, orderBy);
    }
}